...
class AIAssistantOpenAIClasses(override val properties: Properties) : AIAssistant {
    ...
    //alterado para o llm da nvidia
    override fun getSystem() = "NVIDIA"
    override val apiKeyName = "NVIDIA_API_KEY"
    override var model = "google/gemma-2-2b-it"
    ...
    data class OpenAIRequest( //inalterado
        val model: String,
        ...
        // não aceita estes valores val frequency_penalty: Double = 0.0,  // Reduces repetition of token sequences
...
//            Message(role = "system", content = "You are a friendly and helpful assistant."),
        ...
        val openAIRequest =
            OpenAIRequest(model = model,
                messages = messages,
                temperature = temperature, //adicao da temp e max tokens
        ...
        val request = Request.Builder().url("https://integrate.api.nvidia.com/v1/chat/completions") //endpoiunt da nvidia
