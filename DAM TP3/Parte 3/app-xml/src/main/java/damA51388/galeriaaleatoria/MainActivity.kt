...
class MainActivity : AppCompatActivity() {
    ...
    private val viewModel: ImageViewModel by viewModel() // Delegação da gestão de dados ao ViewModel via Koin
    private val favoritesManager: FavoritesManager by inject() // Mecanismo de persistência via Koin
    private val networkMonitor: NetworkMonitor by inject() // Monitor de conetividade via Koin
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Inicialização dos componentes via Koin inject (automático)
